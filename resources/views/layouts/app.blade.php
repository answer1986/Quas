...
<head>
    ...
    <title>Quas.cl |Panel administrativo</title>
    <!-- Scripts -->
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar bg-light elevation-4">
                ...
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="{{asset ('img/Iconos/Q.png')}}" alt="JLDIAZ logo" class="brand-image img-circle"
                        style="opacity: .8">
                    <span class="brand-text font-weight-light">Quas.cl</span>
                </a>
